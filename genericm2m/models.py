...
class BaseGFKRelatedObject(models.Model):
    ...
    """
    # SOURCE OBJECT:
    parent_type = models.ForeignKey(ContentType, related_name="child_%(class)s", on_delete=models.SET_NULL, null=True, blank=True)
    ...
    object_type = models.ForeignKey(ContentType, related_name="related_%(class)s", on_delete=models.SET_NULL, null=True, blank=True)
